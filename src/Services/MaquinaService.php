...
class MaquinaService
{
    ...
    public function __construct()
    {
        $this->array = [
            ...
            ["nombre" => "Press militar con mancuernas", "marca" => "TechnoGym", "imagen" => "pressMilitarMancuernas.jpg"],
            ...
            ["nombre" => "Curl de bíceps con mancuernas", "marca" => "ProGym", "imagen" => "curlBiceps.jpg"],
